                      ...
                      <NavigationMenuTrigger className="bg-transparent group">
                        ...
                        >
                          <span>
                            ...
                            <span
                              className={`block lg:h-[0.1rem] xl:h-[0.3rem] transition-all duration-500  bg-yellow-500  text-white text-lg ${
                                nav.href === pathname
                                  ? "w-full "
                                  ...
                                  <NavigationMenuLink asChild>
                                    ...
                                    >
                                      <Link
                                        ...
                                        shallow={true}
                                        className={cn(
                                          "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-yellow-500/10  focus:bg-yellow-500/10 focus:text-yellow-600 hover:text-yellow-600"
                                        )}
                                      >
                                        {" "}
                      ...
                      <NavigationMenuLink>
                        ...
                        >
                          <span>
                            {String(nav.title).toUpperCase()}
                            <span
                              className={`block lg:h-[0.1rem] xl:h-[0.3rem] transition-all duration-500  bg-yellow-500 rounded-lg text-white text-lg ${
                                nav.href === pathname
                                  ? "w-full "
                                  : "max-w-0 group-hover:max-w-full"
                              }`}
